@echo off
REM Kubernetes Deployment Script for Blue-Green Application (Windows PowerShell)

setlocal enabledelayedexpansion

set NAMESPACE=bluegreen
...
REM Step 2: Apply configuration and secrets
echo [2/5] Creating ConfigMap and Secret...
kubectl apply -f 02-configmap.yaml
kubectl apply -f 03-secret.yaml

REM Step 3: Deploy MongoDB
...
REM Step 5: Deploy Frontends
echo [5/5] Deploying Frontend (Blue and Green)...
